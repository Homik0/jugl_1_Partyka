...
public class Projket1 implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            image5 = ImageIO.read(getClass().getResourceAsStream("/niebo.bmp"));
            image4 = ImageIO.read(getClass().getResourceAsStream("/trawa.bmp"));
        } catch (Exception exc) {
        ...
        t5 = TextureIO.newTexture(image5, false);
...
//        gl.glBegin(GL.GL_TRIANGLE_FAN);
//        gl.glColor3f(1.0f, 1.0f, 0.0f);
//        gl.glVertex3f(0.0f,4.0f,0.0f); //œrodek
//        for(kat = (float) (2.0f*Math.PI); kat >= 0.0f;kat-=(Math.PI/32.0f))
//        {
//            x = 1.5f*(float)Math.sin(kat);
